	...
	<body>
		...
		<div class="container">
			...
			<div class="alert alert-success" role="alert">
				<h4><!-- TemplateBeginEditable name="EditRegion4" -->แก้ไขเนื้อหา<!-- TemplateEndEditable --></h4>
			</div>
			<!-- Card deck -->
			<div class="card-deck">
				<!-- Card -->
				<div class="card mb-4">
					<!--Card image-->
					<div class="view overlay"><!-- TemplateBeginEditable name="EditRegion1" -->แก้ไขเนื้อหา<!-- TemplateEndEditable --></div>
