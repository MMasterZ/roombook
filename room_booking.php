        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button data-bs-dismiss="modal" style='display:none' data-bs-target="#paymentDoc"
                        data-bs-toggle="modal" type="button" class="btn btn-primary"
                        id="pass-validate">จองห้องพัก</button>
                </div>
            </div>
        </div>
    </div>
