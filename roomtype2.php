	...
	<body>
		...
		<div class="container">
			...
			<div class="alert alert-success" role="alert">
				<h4><!-- InstanceBeginEditable name="EditRegion4" -->ห้องพักแบบที่ 2<!-- InstanceEndEditable --></h4>
			</div>
			<!-- Card deck -->
			<div class="card-deck">
				<!-- Card -->
				<div class="card mb-4">
					<!--Card image-->
					<div class="view overlay"><!-- InstanceBeginEditable name="EditRegion1" -->แก้ไขเนื้อหา<!-- InstanceEndEditable --></div>
...
<!DOCTYPE html>
<html lang="en">
<!-- InstanceBegin template="/Templates/templates.dwt.php" codeOutsideHTMLIsLocked="false" -->
...
<body>
    ...
    <div class="container">
        ...
        <div class="alert alert-success" role="alert">
            <h4>
                <!-- InstanceBeginEditable name="EditRegion4" -->ห้องพักแบบที่ 2
                <!-- InstanceEndEditable -->
            </h4>
        </div>
        <!-- Card deck -->
        <div class="card-deck">
            ...
            <div class="card mb-4">
                ...
                <div class="view overlay">
                    <!-- InstanceBeginEditable name="EditRegion1" -->แก้ไขเนื้อหา
                    <!-- InstanceEndEditable -->
                </div>
