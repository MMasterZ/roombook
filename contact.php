...
<html lang="en"><!-- InstanceBegin template="/Templates/templates.dwt.php" codeOutsideHTMLIsLocked="false" -->
	<head>
		...
		<style type="text/css">
		.container .card-deck .card.mb-4 .view.overlay p {
	text-align: center;
}
        </style>
		<!-- InstanceEndEditable -->
	...
	<body>
				...
				<div class="collapse navbar-collapse" id="basicExampleNav">
					...
					<ul class="navbar-nav mr-auto">
					  ...
					  <!-- Dropdown -->
						...
						<li class="nav-item">
							<a class="nav-link" href="contact.php" target="_blank">ติดต่อสอบถาม</a>
						</li>
                        <li class="nav-item">
		...
		<div class="container">
			...
			<div class="alert alert-success" role="alert">
				<h4><!-- InstanceBeginEditable name="EditRegion4" -->ติดต่อสอบถาม<!-- InstanceEndEditable --></h4>
			</div>
			<!-- Card deck -->
			<div class="card-deck">
				<!-- Card -->
				<div class="card mb-4">
					<!--Card image-->
					<div class="view overlay"><!-- InstanceBeginEditable name="EditRegion1" -->
					  <p>บ้านดินถิ่นวาปี รีสอร์ท (Wapi Pathum Earthen House Resort)</p>
                      <p>ที่อยู่: บ้านดินถิ่นวาปี ตำบล หนองแสง อำเภอ วาปีปทุม มหาสารคาม 44120                        </p>
                      <p>ชั่วโมง: เปิด-ปิด 23:30                        </p>
                    <p>โทรศัพท์: 081 318 1361 
                    <center><img src="img/map.jpg" width="720" height="352" alt="map"></p></center>
